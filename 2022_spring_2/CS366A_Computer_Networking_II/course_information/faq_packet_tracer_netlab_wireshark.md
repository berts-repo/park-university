# FAQ: Packet Tracer, Netlab, Wireshark

[link: #fragment-1] Packet Tracer

 [link: #fragment-2] Netlab

 [link: #fragment-3] Wireshark
...
Questions about Wireshark
 ...
 [link: #w1] Q1: What is Wireshark?
 [link: #w2] Q2: Where can I download Wireshark software?
 [link: #w3] Q3: What device do I need to run Wireshark?
 [link: #w4] Q4: What device do I need to run Wireshark?  [link: #w4] 
 [link: #w5] Q5: How do I get the current date and time stamp on the Wireshark? 

Q1: What is Wireshark?
Answer: Wireshark is a packet analyzer which can be used for network traffic analysis and troubleshooting. It is a free, open-source software.

Q2: Where can I download Wireshark software?
Answer: You can download it from wireshark.org/download.html.

Q3: What device do I need to run Wireshark? 
Answer: Wireshark can be run on Windows, Mac OS, or Linux.

Q4: Can I run Wireshark in Park Citrix Virtual Desktop? 
Answer: Yes, login into Park Citrix Virtual Desktop > Cisco Lab > Wireshark.

Q5: How do I get the current date and time stamp on the Wireshark? 
Answer: As soon as you get into Wireshark, the first task to do is to change the date and time display format, by going to View > Time Display Format > select "UTC Date and Time of the Day." This will give you current date when you capture a Wireshark screenshot. For example, see Figure 1 in which the date and time was captured in the Wireshark screenshot.

Figure 1. Wireshark with data and time stamp

...
def execute_query(cur):
    ...
    # This query take finds all transactions that were over $100
    query = """
SELECT 
    customer.CustomerID, customer.Name,
    purchase.TransactionID, purchase.ProductID, purchase.Quantity,
    transaction.Total, transaction.SalesPerson, transaction.PurchaseDate, transaction.PurchaseTime
FROM purchase
...
WHERE transaction.Total > 100.00

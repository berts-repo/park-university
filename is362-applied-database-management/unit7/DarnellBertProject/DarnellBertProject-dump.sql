...
--
-- Host: localhost    Database: DarnellBertProject
-- ------------------------------------------------------
...
CREATE TABLE `purchase` (
  ...
  CONSTRAINT `fk_CustomerID_to_customer` FOREIGN KEY (`CustomerID`) REFERENCES `customer` (`CustomerID`),
  CONSTRAINT `fk_ProductID_to_product` FOREIGN KEY (`ProductID`) REFERENCES `product` (`ProductID`),
  CONSTRAINT `fk_TransactionID_to_transaction` FOREIGN KEY (`TransactionID`) REFERENCES `transaction` (`TransactionID`)
...
-- Dump completed on 2024-04-28 16:25:47

# Unit 5: Research Paper Proposal Guidelines
...
In Unit 5, you should begin thinking about what you want to research.

This link will be helpful to you as you begin your research:  [link: http://en.wikipedia.org/wiki/Terrorism_in_the_United_States] http://en.wikipedia.org/wiki/Terrorism_in_the_United_States
...
For example, you can compare second-hand accounts of old newspaper reports that you can find online or radio recordings or TV news clips available online on YouTube or on various credible history sites. As you’ve been practicing in Discussions in this course, analyze the media coverage; look for evidence of bias, framing, assumptions, speculations and even factual, substantial reporting. You can also report on what historians, sociologists and political scientists wrote about how media covered the event. If you find a front-page cover photo that sensationalizes the event, think about applying what you learned in chapter 4 of the course textbook about studies on the impact of images.

Directions for Proposal Assignment and Timeline

During Unit 5, you should allocate time to consider and think about what you would like to research.

The proposal for your research paper is due the end of Unit 6. You will upload a document that looks and reads like an elaborated outline and includes at least three sources that you will use to discuss how they relate to 2 of the 8 criteria listed above.  
...
Format: The proposal document should be at least one single-spaced page plus a correctly formatted reference page. Use APA style and at least 3 references and 12-point font.

Tips on Conducting Research Online

During Unit 5, watch the following curated list of video tutorials, especially if it’s been awhile since you have taken an English course on academic research and writing:

The CRAAP method of evaluating websites:

 [link: https://www.youtube.com/watch?v=aem3JahbXfk] Evaluating Websites

More on using CRAAP to evaluate websites:

 [link: https://www.youtube.com/watch?v=EyMT08mD7Ds] Evaluating Sources

A variation on the CRAAP method:

 [link: https://www.youtube.com/watch?v=T4nmiJLhB5c] Evaluating Web Pages Tutorial

On whether Wikipedia a credible source:

 [link: https://www.youtube.com/watch?v=jHrGsxSpM5E] Is Wikipedia a Credible Source?

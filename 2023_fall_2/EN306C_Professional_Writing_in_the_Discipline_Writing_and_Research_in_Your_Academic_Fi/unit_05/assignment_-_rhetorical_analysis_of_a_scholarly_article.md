# Unit 5: Assignment - Rhetorical Analysis of a Scholarly Article

**Due:** 2023-11-20T05:59:00Z
...
For this assignment, you are going to choose a scholarly, peer-reviewed article in your field (perhaps from one of the journals you identified in Unit 2), and write a 5-page essay in which you draw from the course readings to analyze the article as a representation of the field’s writing conventions.
...
Effectively revise a draft using feedback from other readers (CLO 2)

Analyze an academic article using rhetorical principles (CLO 1)

Develop a specific analytical thesis statement (CLO 2)

Support thesis effectively with evidence and analysis (CLO 2)

Effectively use a secondary source to analyze a primary source (CLO 3)

Use correct citation format for in-text citations (CLO 3)
...
**Score:** 100.0/100.0
**Grade:** 100
**Submitted:** 2023-11-20T02:36:48Z

### Submitted Files

- **assignment5-4.docx**
  - Downloaded: `files/assignment5-4.docx`

### Instructor Feedback

**[INSTRUCTOR]** (2023-12-07T21:30:01Z):

> Bert, fantastic work here creating a clear focus and providing specifics for each paragraph that back up your focus. I appreciate the level of attention you've given to this assignment.

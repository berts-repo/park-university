# Unit 6: Assignment - Core Assessment - Game-Playing Agent

**Due:** 2023-12-11T05:59:00Z
...
A Python 3 IDE (either  [link: https://thonny.org/] Thonny or another IDE) and  [link: https://desktop.github.com/] GitHub. 
...
Your instructor will provide you with a link to a GitHub template repository with the minimax code from  [link: https://artint.info/AIPython/] AIPython modified to represent game states for the chosen game for this semester. Create your own private repository based on this template and share access with your partner and your instructor. They should both provide you with their GitHub usernames.
...
Submit by the end of Unit 8 (Sunday, 11:59p.m., CT.)
...
**Score:** 170.0/170.0
**Grade:** 170
**Submitted:** 2023-11-27T05:03:39Z

### Submitted Files

- **reversiGame.py**
  - Downloaded: `files/reversiGame.py`

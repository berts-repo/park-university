...
The first file will contain the declaration and initialization of an external array of integer values named globalArray. The size of this array should be kept in the macro constant named SIZE, and it should be set to 10. The elements of the array should be all set initially to zero.

This first file will also contain the definition of three functions. All these functions will work with the globalArray and its SIZEas set above:
...
**Score:** 10.0/10.0
**Grade:** 10
**Submitted:** 2021-09-18T06:41:21Z

### Submitted Files

- **BertUnit5.sln**
  - Downloaded: `files/BertUnit5.sln`

### Instructor Feedback

**Bert** (2021-09-18T06:41:21Z):

> Hello professor,
I believe I submitted the correct project file. I'm not sure how compiling works if you don't have the .cpp and .hpp files. Let me know if you need those to, I didn't see you ask for them in the instructions though.
I am particularly curious if I used the pointer correctly in the print function. To my understanding the print stack is higher then the main() stack. I couldn't find a way to write the new string directly on the old string, due to the global string, due to it being a constant. Hopefully I am pointing correctly and am using less memory than calling the string each time.

**Luke Donoho** (2021-09-21T10:33:59Z):

...
public class DB08GUIPortionCode extends Application{
  //---------------------------------------
  // data access
  ...
  public void start(Stage stage) {  
    ...
    stage.setTitle("DB08 | Course Registration");
    stage.show();
  }
  ...
  private void searchCourse() {
    ...
    initScheduleListView(); 
	 ...
	 if (courseNumStr.isEmpty()){
		 displayAlert("Course Search", "Please provide a valid course id.");
      courseNumTextField.requestFocus();
      courseNumTextField.selectAll();
		return;      
	 }
    // search and load course schedule of this student
    courseSearchResultList = rm.searchByCourseNumber(courseNumStr);

...
2. Bulk import data into a relational database management system (CLO 3, CLO 4)
...
**Score:** 100.0/100.0
**Grade:** 100
**Submitted:** 2024-04-24T16:30:41Z

### Submitted Files

- **Bertassig07-dump.sql**
  - Downloaded: `files/Bertassig07-dump.sql`

### Instructor Feedback

**[INSTRUCTOR]** (2024-05-01T14:59:37Z):

> Bert, well executed - your database query and result table "species" record count match the formula in the Clements spreadsheet both showing the category = “subspecies” and that have a scientificName that begins with the first letter of the student’s last name.  See Rubric comments for detailed feedback -  Great work!

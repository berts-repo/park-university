...
**Score:** 100.0/100.0
**Grade:** 100
**Submitted:** 2024-04-28T20:31:45Z

### Submitted Files

- **BertProject.zip**
  - Downloaded: `files/BertProject.zip`

### Instructor Feedback

**[INSTRUCTOR]** (2024-05-02T20:52:22Z):

> Bert, superb work in producing a report table from all 3 py programs. Your work clearly shows you have a profound understanding of the material - All 3 .py programs were well developed and executed as intended.

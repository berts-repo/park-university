...
**Score:** 100.0/100.0
**Grade:** 100
**Submitted:** 2024-04-16T01:52:12Z
**Late:** Yes

### Submitted Files

- **BertProject05rdm.png**
  - Downloaded: `files/BertProject05rdm.png`
- **BertProject05.sql**
  - Downloaded: `files/BertProject05.sql`

### Instructor Feedback

**[INSTRUCTOR]** (2024-04-20T14:49:22Z):

> Bert, outstanding work thus far on your Project. You have complied with all the objectives outlined in the Project Part 2 directions. I was able to import your submitted dump file with no issues and review all aspects of the database. The database aligns with both the ERD and RDM and showcases the proper number of records for each Table along with identified constraints, PK/FK relationships.
